                    ...
                    <form className=" login-card col-9 col-lg-6 d-flex align-items-center flex-column gap-2">
                        ...
                        <div className="w-100 d-flex flex-row justify-content-evenly my-3">
                            <div className="d-flex flex-column ">
                                ...
                                <input type="text" id="Fname" className=" login-input form-control  w-100 " name="Fname"  placeholder="....." />
                            </div>
                            <div className="d-flex flex-column ">
                                <label htmlFor="Lname" className="text-white">Last name</label>
                                <input type="text" id="Lname" className=" login-input form-control  w-100 " name="Lname" placeholder="....." />
                            </div>
                        </div>
                        ...
                        <div className="  w-100 d-flex align-items-center flex-column gap-2 ">
                            ...
                            <input type="email" id="email" className=" login-input form-control w-75  " placeholder="Enter your email" />
                            <label htmlFor="pass" className="text-white w-75 mt-3">Password</label>
                            <input type="password" id="pass" name="pass" className=" login-input form-control w-75 " placeholder="Enter your password " />
                            <label htmlFor="Cpass" className="text-white w-75 mt-3">Confirm Password</label>
                            <input type="password" id="Cpass" name="Cpass" className=" login-input form-control w-75 " placeholder="Repeat your password " />
                        </div>
                        ...
                        <button type="submit" className="btn  px-5 rounded bg-primary w-75">submit</button>
