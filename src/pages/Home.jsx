          ...
          <div className="container">
            <div className="row align-items-center g-5 min-vh-90">
              ...
              <div className="col-12 col-lg-7 text-center text-lg-start hero-content">
                ...
                <p
                  className="fs-5 text-muted mx-auto mx-lg-0 hero-text"
                ...
                {/* Buttons */}
                <div className="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start py-3 hero-buttons">
                ...
                {/* Statistics */}
                <div className="row text-center text-lg-start mt-4 hero-stats">
              ...
              {/* Hero Image */}
              <div className="col-12 col-lg-5 text-center hero-image">
